...
filename = 'ipmisel_DP1.json'
filename2 = 'ipmisel_DP'
respuesta_final =[]
#***********************************************************************************
...
for i in range(total_targets):
    ...
    url = librerias.hosts.ipaddr[i] + librerias.hosts.defaultstat + 'IPMISelEvents'
    ...
    if 'IPMISelEvents' in response.json():
        #convertimos la respuesta en formato json
        parsed_response = response.json()['IPMISelEvents']
    else:
