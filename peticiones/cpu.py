...
for i in range(total_targets):
    ...
    #se asigna la url con base en el archivo librerías, que a su vez contiene información de la url a usar
    url = librerias.hosts.ipaddr[i] + librerias.hosts.defaultstat + 'CPUUsage'   
    ...
    if 'CPUUsage' in response.json():
        #convertimos la respuesta en formato json
        parsed_response = response.json()['CPUUsage']
    else:
         parsed_response=response.json()['result']
