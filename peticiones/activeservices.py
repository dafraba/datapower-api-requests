...
filename = 'activeServices_DP1.json'
filename2 = 'activeServices_DP'
respuesta_final =[]
#***********************************************************************************
...
def valida_dir_file(filename,filename_final):
    ...
    shutil.copy(filename, librerias.servicesdir)
    shutil.copy(filename_final, librerias.servicesdir)
...
for i in range(total_targets):
    ...
    for diccionario in datos:
        ...
        url= librerias.hosts.ipaddr[i] + librerias.hosts.status + domainname + "/ServicesStatus"
        ...
        parsed_response = response.json()['ServicesStatus'] 
