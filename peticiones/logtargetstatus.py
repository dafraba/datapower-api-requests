...
filename = 'logTargetStatus_DP_1.json'
filename2 = 'logTargetStatus_DP_'
respuesta_final =[]
respuesta_final2=[]
#***********************************************************************************
...
def valida_dir_file(filename,filename_final):
    #se guarda la ruta del archivo y se le concatena el nombre del mismo
    path_archivo_dp1 = librerias.os.path.join(librerias.ltdir, filename)
    path_archivo_dp2 = librerias.os.path.join(librerias.ltdir, filename_final)
    ...
    shutil.copy(filename, librerias.ltdir)
    shutil.copy(filename_final, librerias.ltdir)
...
for i in range(total_targets):
    ...
    for diccionario in datos:
        ...
        url= librerias.hosts.ipaddr[i] + librerias.hosts.status + domainname + "/LogTargetStatus"
        ...
        parsed_response = response.json()['LogTargetStatus'] 
